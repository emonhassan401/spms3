...
-- AlterTable
ALTER TABLE `obestudent` MODIFY `student_name` VARCHAR(191) NOT NULL DEFAULT 'No Name',
    MODIFY `courseID` VARCHAR(191) NOT NULL DEFAULT 'CS-101',
    MODIFY `section` INTEGER NOT NULL DEFAULT 1,
    MODIFY `semester` VARCHAR(191) NOT NULL DEFAULT 'Fall';
