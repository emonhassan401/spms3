...
-- AlterTable
ALTER TABLE `obestudent` MODIFY `total` INTEGER NOT NULL DEFAULT 0,
    MODIFY `CO1` INTEGER NOT NULL DEFAULT 0,
    MODIFY `CO2` INTEGER NOT NULL DEFAULT 0,
    MODIFY `CO3` INTEGER NOT NULL DEFAULT 0,
    MODIFY `CO4` INTEGER NOT NULL DEFAULT 0,
    MODIFY `grade` VARCHAR(191) NOT NULL DEFAULT 'F';
